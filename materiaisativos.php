<?php
    ...
    $lista = $material_service->listarMateriasAtivos($pagina,$limit);
    $total=$material_service->totalMateriaisAtivos();
...
<body>
    ...
    <section>
        <h4 style="margin-top:60px " class="text-center mb-4 text-primary">Materiais Ativos</h4>
        <div class="container mb-5" id="cont"> 
           ...
           <div class="table-responsive mb-4">
            <table class="table table-light table-hover text-secondary tabela-materiais table-bordered" id="tabela-materias">
        ...
        <?php foreach ($lista as $key => $dado){ ?>
                <tr class="">
                  ...
                  <td><?= $dado['situacao'] ?></td>
                  <td>
                    <button onclick="editar(<?= $dado['id'] ?>,'<?= $dado['descricao'] ?>','<?= $_SESSION['id_hospital'] ?>')" class="btn btn-primary"><i class="far fa-edit"></i></button>
                  </td>

                  <td>
                    <button onclick="desativa(<?= $dado['id'] ?>,'<?= $_SESSION['id_hospital'] ?>')" class="btn btn-danger"><i class="far fa-times-circle"></i></button>
                  </td>
                </tr>
        ...
        <?php } ?>
            ...
            <div class="container p-2 pt-3 pb-2" id="div-table-bottom">
              <!----- links de paginação ------->
            <a class="btn btn-secondary btn-sm ml-2" href="materiaisativos.php?pagina=0">PRIMEIRA</a>
            <?php 
             ...
             ?>    
               <a class="btn btn-secondary btn-sm" href="materiaisativos.php?pagina=<?= $i ?>"> <?= $i ?></a>
              <?php       }
              }
 
              } ?>
              <a class="btn btn-secondary btn-sm" href="materiaisativos.php?pagina=<?= $qtdPag ?>">ÚLTIMA</a> 
